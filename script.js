...
    { username: 'SerenAtkins', password: 'SA3009' }
...
             if (googleSheetsUrl === 'YOUR_APPS_SCRIPT_WEB_APP_URL' || !googleSheetsUrl || googleSheetsUrl === 'https://script.google.com/macros/s/AKfycbxVoMD8mBwGt8gqUw4Yoky8ShMRoPjdymDgSLaulM9xitBgauTNTCr6psdtUeRm4h6hOA/exec') { // Added check for the placeholder URL
...
     // We now calculate/update only ONCE when initializeSalesBook is called on page load
     /* document.querySelectorAll('tbody tr').forEach(row => {
...
    // MODIFICATION : Appel direct pour afficher le carnet de vente et l'initialiser
    showSalesBook();
    initializeSalesBook();
});
